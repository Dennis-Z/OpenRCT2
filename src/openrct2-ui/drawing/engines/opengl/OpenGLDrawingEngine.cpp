...
public:
    ...
    void DrawSprite(uint32 image, sint32 x, sint32 y, uint32 tertiaryColour, LightingSpriteData lightingData) override;
...
void OpenGLDrawingContext::DrawSprite(uint32 image, sint32 x, sint32 y, uint32 tertiaryColour, LightingSpriteData lightingData)
{
...
void OpenGLDrawingContext::DrawSpriteRawMasked(sint32 x, sint32 y, uint32 maskImage, uint32 colourImage, LightingSpriteData lightingData)
{
