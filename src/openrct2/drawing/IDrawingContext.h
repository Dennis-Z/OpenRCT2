...
namespace OpenRCT2 { namespace Drawing
{
    ...
    interface IDrawingContext
    {
        ...
        virtual void DrawSprite(uint32 image, sint32 x, sint32 y, uint32 tertiaryColour, LightingSpriteData lightingData)                      abstract;
        virtual void DrawSpriteRawMasked(sint32 x, sint32 y, uint32 maskImage, uint32 colourImage, LightingSpriteData lightingData)            abstract;
